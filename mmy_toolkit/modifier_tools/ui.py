...
MODIFIER_CATEGORIES = {
    "生成": [
        ...
        ('SOLIDIFY', "实体化", 'NONE'),
        ('SUBSURF', "细分", 'NONE'),
        ('TRIANGULATE', "三角化", 'NONE'),
        ('VOLUME_TO_MESH', "体积转网格", 'NONE'),
        ('WELD', "焊接", 'NONE'),
        ('WIREFRAME', "线框", 'NONE'),
    ],
    "变形": [
        ...
        ('DISPLACE', "置换", 'NONE'),
        ('HOOK', "钩子", 'HOOK'),
        ('LAPLACIANDEFORM', "拉普拉斯变形", 'NONE'),
        ('LAPLACIANSMOOTH', "拉普拉斯平滑", 'NONE'),
        ('LATTICE', "晶格", 'NONE'),
        ('MESH_DEFORM', "网格变形", 'NONE'),
        ('SHRINKWRAP', "收缩包裹", 'NONE'),
        ('SIMPLE_DEFORM', "简易变形", 'NONE'),
        ('SMOOTH', "平滑", 'NONE'),
        ('CORRECTIVE_SMOOTH', "矫正平滑", 'NONE'),
        ('SURFACE_DEFORM', "表面变形", 'NONE'),
        ('WARP', "扭曲", 'NONE'),
        ('WAVE', "波浪", 'NONE'),
    ],
    "修改": [
        ('DATA_TRANSFER', "数据传递", 'NONE'),
        ('MESH_CACHE', "网格缓存", 'NONE'),
        ('MESH_SEQUENCE_CACHE', "网格序列缓存", 'NONE'),
        ('NORMAL_EDIT', "编辑法向", 'NONE'),
        ('WEIGHTED_NORMAL', "加权法向", 'NONE'),
        ('UV_PROJECT', "UV投射", 'NONE'),
        ('UV_WARP', "UV扭曲", 'NONE'),
        ('VERTEX_WEIGHT_EDIT', "顶点权重编辑", 'NONE'),
        ('VERTEX_WEIGHT_MIX', "顶点权重混合", 'NONE'),
        ('VERTEX_WEIGHT_PROXIMITY', "顶点权重邻近", 'NONE'),
    ],
    "物理": [
        ('CLOTH', "布料", 'NONE'),
        ('COLLISION', "碰撞", 'NONE'),
        ('DYNAMIC_PAINT', "动态绘画", 'NONE'),
        ('EXPLODE', "爆炸", 'NONE'),
        ('FLUID', "流体", 'NONE'),
        ('OCEAN', "海洋", 'NONE'),
        ('PARTICLE_INSTANCE', "粒子实例", 'NONE'),
        ('PARTICLE_SYSTEM', "粒子系统", 'NONE'),
        ('SOFT_BODY', "软体", 'NONE'),
    ],
}
