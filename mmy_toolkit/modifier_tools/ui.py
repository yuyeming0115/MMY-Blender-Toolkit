...
MODIFIER_CATEGORIES = {
    "生成": [
        ('ARRAY', "阵列", 'ALIGN'),
        ('BEVEL', "倒角", 'MODIFIER'),
        ('BOOLEAN', "布尔", 'SELECT_DIFFERENCE'),
        ('BUILD', "构建", 'TIME'),
        ('DECIMATE', "精简", 'X'),
        ('EDGE_SPLIT', "拆边", 'EDGESEL'),
        ('MASK', "遮罩", 'MODIFIER'),
        ('MIRROR', "镜像", 'MOD_MIRROR'),
        ('MULTIRES', "多级精度", 'MODIFIER'),
        ('NODES', "几何节点", 'NODETREE'),
        ...
        ('TRIANGULATE', "三角化", 'MODIFIER'),
        ('VOLUME_TO_MESH', "体积转网格", 'VOLUME_DATA'),
        ('WELD', "焊接", 'AUTOMERGE_ON'),
    ...
    "变形": [
        ...
        ('HOOK', "钩子", 'HOOK'),
        ('LAPLACIANDEFORM', "拉普拉斯变形", 'MODIFIER'),
        ('LAPLACIANSMOOTH', "拉普拉斯平滑", 'SMOOTH'),
        ('LATTICE', "晶格", 'LATTICE_DATA'),
        ('MESH_DEFORM', "网格变形", 'MESH_DATA'),
        ('SHRINKWRAP', "收缩包裹", 'SURFACE_DATA'),
        ('SIMPLE_DEFORM', "简易变形", 'MODIFIER'),
        ('SMOOTH', "平滑", 'SMOOTH'),
        ('CORRECTIVE_SMOOTH', "矫正平滑", 'SMOOTH'),
        ('SURFACE_DEFORM', "表面变形", 'SURFACE_DATA'),
        ('WARP', "扭曲", 'MODIFIER'),
        ('WAVE', "波浪", 'MODIFIER'),
    ],
    "修改": [
        ('DATA_TRANSFER', "数据传递", 'COPY_ID'),
        ('MESH_CACHE', "网格缓存", 'FILE'),
        ('MESH_SEQUENCE_CACHE', "网格序列缓存", 'FILE'),
        ('NORMAL_EDIT', "编辑法向", 'NORMALS_FACE'),
        ('WEIGHTED_NORMAL', "加权法向", 'NORMALS_VERTEX'),
    ...
    "物理": [
        ...
        ('DYNAMIC_PAINT', "动态绘画", 'PAINT_CANVAS'),
        ('EXPLODE', "爆炸", 'PARTICLES'),
        ('FLUID', "流体", 'FLUID'),
        ('OCEAN', "海洋", 'WATER'),
        ('PARTICLE_INSTANCE', "粒子实例", 'PARTICLE_DATA'),
        ('PARTICLE_SYSTEM', "粒子系统", 'PARTICLES'),
