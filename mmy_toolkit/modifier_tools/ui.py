...
MODIFIER_CATEGORIES = {
    "生成": [
        ('ARRAY', "阵列", 'MESH_DATA'),
        ('BEVEL', "倒角", 'MESH_DATA'),
        ('BOOLEAN', "布尔", 'MESH_DATA'),
        ('BUILD', "构建", 'TIME'),
        ('DECIMATE', "精简", 'MESH_DATA'),
        ('EDGE_SPLIT', "拆边", 'MESH_DATA'),
        ('MASK', "遮罩", 'MESH_DATA'),
        ('MIRROR', "镜像", 'MESH_DATA'),
        ('MULTIRES', "多级精度", 'MESH_DATA'),
        ('NODES', "几何节点", 'NODETREE'),
        ('REMESH', "重构网格", 'MESH_DATA'),
        ('SCREW', "螺旋", 'MESH_DATA'),
        ('SKIN', "蒙皮", 'MESH_DATA'),
        ('SOLIDIFY', "实体化", 'MESH_DATA'),
        ('SUBSURF', "细分", 'MESH_DATA'),
        ('TRIANGULATE', "三角化", 'MESH_DATA'),
        ('VOLUME_TO_MESH', "体积转网格", 'VOLUME_DATA'),
        ('WELD', "焊接", 'MESH_DATA'),
        ('WIREFRAME', "线框", 'MESH_DATA'),
    ],
    "变形": [
        ('ARMATURE', "骨架", 'ARMATURE_DATA'),
        ('CAST', "投射", 'MESH_DATA'),
        ('CURVE', "曲线", 'CURVE_DATA'),
        ('DISPLACE', "置换", 'TEXTURE_DATA'),
        ('HOOK', "钩子", 'HOOK'),
        ('LAPLACIANDEFORM', "拉普拉斯变形", 'MESH_DATA'),
        ('LAPLACIANSMOOTH', "拉普拉斯平滑", 'MESH_DATA'),
        ('LATTICE', "晶格", 'LATTICE_DATA'),
        ('MESH_DEFORM', "网格变形", 'MESH_DATA'),
        ('SHRINKWRAP', "收缩包裹", 'MESH_DATA'),
        ('SIMPLE_DEFORM', "简易变形", 'MESH_DATA'),
        ('SMOOTH', "平滑", 'MESH_DATA'),
        ('CORRECTIVE_SMOOTH', "矫正平滑", 'MESH_DATA'),
        ('SURFACE_DEFORM', "表面变形", 'MESH_DATA'),
        ('WARP', "扭曲", 'MESH_DATA'),
        ('WAVE', "波浪", 'MESH_DATA'),
    ],
    "修改": [
        ('DATA_TRANSFER', "数据传递", 'MESH_DATA'),
        ('MESH_CACHE', "网格缓存", 'FILE'),
        ('MESH_SEQUENCE_CACHE', "网格序列缓存", 'FILE'),
        ('NORMAL_EDIT', "编辑法向", 'MESH_DATA'),
        ('WEIGHTED_NORMAL', "加权法向", 'MESH_DATA'),
        ('UV_PROJECT', "UV投射", 'GROUP_UVS'),
        ('UV_WARP', "UV扭曲", 'GROUP_UVS'),
        ('VERTEX_WEIGHT_EDIT', "顶点权重编辑", 'GROUP_VCOL'),
        ('VERTEX_WEIGHT_MIX', "顶点权重混合", 'GROUP_VCOL'),
        ('VERTEX_WEIGHT_PROXIMITY', "顶点权重邻近", 'GROUP_VCOL'),
    ],
    "物理": [
        ('CLOTH', "布料", 'MATCLOTH'),
        ('COLLISION', "碰撞", 'PHYSICS'),
        ('DYNAMIC_PAINT', "动态绘画", 'IMAGE_DATA'),
        ('EXPLODE', "爆炸", 'PARTICLE_DATA'),
        ('FLUID', "流体", 'FLUID'),
        ('OCEAN', "海洋", 'IMAGE_DATA'),
        ('PARTICLE_INSTANCE', "粒子实例", 'PARTICLE_DATA'),
        ('PARTICLE_SYSTEM', "粒子系统", 'PARTICLE_DATA'),
        ('SOFT_BODY', "软体", 'PHYSICS'),
    ],
}
